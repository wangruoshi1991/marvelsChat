...
test("registers the complete private avatar Web API contract", () => {
  ...
  const expected = [
    ...
    ["get", "/api/avatar-3d/jobs/:jobId/references"],
    ["get", "/api/avatar-3d/jobs/:jobId/references/:view/file"],
    ["post", "/api/avatar-3d/jobs/:jobId/references/confirm"],
    ["post", "/api/avatar-3d/jobs/:jobId/references/reject"],
